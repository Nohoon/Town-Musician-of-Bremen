    ...
    public class DiggerMasterEditor : Editor
    {
        ...
        public void OnInspectorGUIEditTab()
        {
            ...
            if (diggerSystem) {
                ...
                action = (ActionType) EditorGUILayout.EnumPopup(new GUIContent("Action", "Shortcuts: A (Add), D (Dig), P (Paint), S (Smooth)"), action);
                ...
                size = EditorGUILayout.Slider(new GUIContent("Brush Size", "Shortcut: keypad - or +"), size, 0.5f, 20f);
                ...
                if (action != ActionType.Reset) {
                    opacity = EditorGUILayout.Slider(new GUIContent("Opacity", "Shortcut: keypad / or *"), opacity, 0f, 1f);
